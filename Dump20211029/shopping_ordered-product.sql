...
CREATE TABLE `ordered-product` (
  ...
  CONSTRAINT `fk_product_has_order_product` FOREIGN KEY (`product_id`) REFERENCES `product` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
-- Dump completed on 2021-10-29  9:06:12
