...
<div class="col-lg-3 mt-lg-0 mt-4 p-lg-0">
    <div class="side-bar p-sm-4 p-3">
        <div class="left-side border-bottom py-2">
            <h3 class="agileits-sear-head mb-3">Admin Panel</h3>
            <ul>
                <li>
                    <a href="/users"> <span class="span">User</span>
                    </a>
                </li>
				<li>
					<a href="/categories"> <span class="span">Category</span>
					</a>
				</li>
				<li>
					<a href="/users"> <span class="span">Product</span>
					</a>
				</li>
				<li>
					<a href="/users"> <span class="span">Customer</span>
					</a>
				</li>
				<li>
					<a href="/users"> <span class="span">Order</span>
					</a>
				</li>
